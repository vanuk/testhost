    ...
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Сurriculums", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    СurriculumId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Groups_Сurriculums_СurriculumId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FormOfControl = table.Column<int>(type: "int", nullable: false),
                    Credits = table.Column<float>(type: "real", nullable: false),
                    Lectures = table.Column<float>(type: "real", nullable: false),
                    Labworks = table.Column<float>(type: "real", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_Сurriculums_СurriculumId",
                        column: x => x.СurriculumId,
                        principalTable: "Сurriculums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
